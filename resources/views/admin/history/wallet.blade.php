        ...
        <div class="card">
            <div class="card-block">
                <div class="row">
                    ...
                    <div class="col text-right">
                        <h3 class="text-c-green f-w-300">{{currencyFormat($credit->sum('transactions.amount'))}}</h3>
        ...
        <div class="card">
            <div class="card-block">
                <div class="row">
                    ...
                    <div class="col text-right">
                        <h3 class="text-c-green f-w-300">{{currencyFormat($debit->sum('transactions.amount'))}}</h3>
