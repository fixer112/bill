    ...
    Route::middleware(['auth', 'checkStatus'])->group(function () {
        ...
        Route::prefix('user')->group(function () {
            ...
            Route::middleware(['subscribed'])->group(function () {
                ...
                Route::post('/wallet/{user}/fund', 'AdminController@fundWallet')->block(env('BLOCK_LIMIT', 60));
                ...
                Route::post('/wallet/{user}/transfer', 'UserController@transfer')->block(env('BLOCK_LIMIT', 60));
